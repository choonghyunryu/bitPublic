...
##==============================================================================
admi_seoul |> 
  select(BASE_YQ:CTY_NM, VIATR_FCLTY_CNT:BUS_STTN_CNT) |> 
...
##==============================================================================
dbWriteTable(con, "TB_SEOUL_VIATRFCLTY_CTY", admi_seoul_cty, overwrite = TRUE)
# dbGetQuery(con, "select * from TB_SEOUL_VIATRFCLTY_CTY limit 5;")
