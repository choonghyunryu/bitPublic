...
service_id <- "VwsmAdstrdNcmCnsmpW"
...
##==============================================================================
admi_seoul <- admi_seoul |> 
  rename(AVG_INCM_AMT = MT_AVRG_INCOME_AMT) |> 
  rename(INCM_GRD_CD = INCOME_SCTN_CD) |> 
...
dbWriteTable(con, "TB_SEOUL_EXPNDTR_ADMI", admi_seoul, overwrite = TRUE)
# dbGetQuery(con, "select * from TB_SEOUL_EXPNDTR_ADMI limit 5;")
