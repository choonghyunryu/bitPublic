...
dbWriteTable(con, "TB_SEOUL_STRTPOP_ADMI", admi_seoul, overwrite = TRUE)
# dbGetQuery(con, "select * from TB_SEOUL_STRTPOP_ADMI limit 5;")
...
##==============================================================================
admi_seoul |> 
  select(BASE_YQ:CTY_NM, TOT_FLPOP_CNT:SUN_FLPOP_CNT) |> 
...
##==============================================================================
dbWriteTable(con, "TB_SEOUL_STRTPOP_CTY", admi_seoul_cty, overwrite = TRUE)
# dbGetQuery(con, "select * from TB_SEOUL_STRTPOP_CTY limit 5;")
